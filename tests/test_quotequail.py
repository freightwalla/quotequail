...
class HTMLQuoteTestCase(unittest.TestCase):
    ...
    def test_outlook(self):
        self.assertEqual(
            quote_html(
                u"""<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns:m="http://schemas.microsoft.com/office/2004/12/omml" xmlns="http://www.w3.org/TR/REC-html40"><head></head><body lang=EN-US link=blue vlink=purple><div class=WordSection1><p class=MsoNormal><span style='font-size:11.0pt;font-family:"Calibri","sans-serif";color:#1F497D'>Thanks,<o:p></o:p></span></p><p class=MsoNormal><span style='font-size:11.0pt;font-family:"Calibri","sans-serif";color:#1F497D'><o:p>&nbsp;</o:p></span></p><p class=MsoNormal><span style='font-size:11.0pt;font-family:"Calibri","sans-serif";color:#1F497D'><o:p>&nbsp;</o:p></span></p><div><div style='border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in'><p class=MsoNormal><b><span style='font-size:10.0pt;font-family:"Tahoma","sans-serif"'>From:</span></b><span style='font-size:10.0pt;font-family:"Tahoma","sans-serif"'> John Doe [mailto:john@example.com] <br><b>Sent:</b> Tuesday, December 30, 2014 5:31 PM<br><b>To:</b> recipient@example.com<br><b>Subject:</b> Excited to have you on board!<o:p></o:p></span></p></div></div><p class=MsoNormal><o:p>&nbsp;</o:p></p><p>Hey,<o:p></o:p></p></div></body></html>"""
            ),
            [
                (
                    True,
                    u'<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns:m="http://schemas.microsoft.com/office/2004/12/omml" xmlns="http://www.w3.org/TR/REC-html40"><head></head><body lang="EN-US" link="blue" vlink="purple"><div class="WordSection1"><p class="MsoNormal"><span style=\'font-size:11.0pt;font-family:"Calibri","sans-serif";color:#1F497D\'>Thanks,<o:p></o:p></span></p><p class="MsoNormal"><span style=\'font-size:11.0pt;font-family:"Calibri","sans-serif";color:#1F497D\'><o:p>\xa0</o:p></span></p><p class="MsoNormal"><span style=\'font-size:11.0pt;font-family:"Calibri","sans-serif";color:#1F497D\'><o:p>\xa0</o:p></span></p><div></div></div></body></html>',
                ),
                (
                    False,
                    u'<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:w="urn:schemas-microsoft-com:office:word" xmlns:m="http://schemas.microsoft.com/office/2004/12/omml" xmlns="http://www.w3.org/TR/REC-html40"><head></head><body lang="EN-US" link="blue" vlink="purple"><div class="WordSection1"><div><div style="border:none;border-top:solid #B5C4DF 1.0pt;padding:3.0pt 0in 0in 0in"><p class="MsoNormal"><b><span style=\'font-size:10.0pt;font-family:"Tahoma","sans-serif"\'>From:</span></b><span style=\'font-size:10.0pt;font-family:"Tahoma","sans-serif"\'> John Doe [mailto:john@example.com] <br><b>Sent:</b> Tuesday, December 30, 2014 5:31 PM<br><b>To:</b> recipient@example.com<br><b>Subject:</b> Excited to have you on board!<o:p></o:p></span></p></div></div><p class="MsoNormal"><o:p>\xa0</o:p></p><p>Hey,<o:p></o:p></p></div></body></html>',
                ),
            ],
        )
    ...
    def test_no_wrap_tag(self):
        self.assertEqual(
            quote_html(
                u"""On Thu, Dec 18, 2014 at 10:02 AM, foo &lt;foo@example.com&gt; wrote:<blockquote>some stuff</blockquote>"""
            ),
            [
                (
                    True,
    ...
    def test_images(self):
        self.assertEqual(
            ...
            [
                (
                    True,
                    u"""<div>Well hello there Sir!!!<br><br><br>On Dec 23, 2014, at 04:35 PM, Steve Wiseman &lt;wiseman.steve@ymail.com&gt; wrote:</div>""",
                ),
                (
                    False,
                    u"""<div><blockquote type="cite"><div style="color:#000;"><div dir="ltr">Hi there\xa0<img src=\"https://s.yimg.com/ok/u/assets/img/emoticons/emo14.gif\" alt=\"*B-) cool\" title=\"*B-) cool\" class=\"fr-fin\"><img src=\"https://s.yimg.com/ok/u/assets/img/emoticons/emo7.gif\" alt=\"*:P tongue\" title=\"*:P tongue\" class=\"fr-fin\"><img src=\"https://s.yimg.com/ok/u/assets/img/emoticons/emo72.gif\" alt=\"*:-&gt;~~ spooky\" title=\"*:-&gt;~~ spooky\" class=\"fr-fin\"></div></div></blockquote></div>""",
                ),
            ],
        )
    ...
    def test_comment_3(self):
        self.assertEqual(
            quote_html(
                u"""<!-- test --><br><br>Begin forwarded message:<br><br><!-- test -->"""
            ),
            [
...
class InternalTestCase(unittest.TestCase):
    def test_parse_reply(self):
        ...
        data = parse_reply(
            u"Am 24.02.2015 um 22:48 schrieb John Doe <john@doe.example>:"
        )
        self.assertEqual(
            data,
            {"date": u"24.02.2015 um 22:48", "from": u"John Doe <john@doe.example>"},
        )

        data = parse_reply(
            u"On Monday, March 7, 2016 10:19 AM, John Doe <john@doe.example> wrote:"
        )
        self.assertEqual(
            data,
            {
        ...
        data = parse_reply(
            u"On Feb 22, 2015, at 9:19 PM, John Doe <john@doe.example> wrote:"
        )
        self.assertEqual(
            data,
            {
        ...
        data = parse_reply(
            u"On 2016-03-14, at 20:26, John Doe <john@doe.example> wrote:"
        )
        self.assertEqual(
            data,
            {"date": u"2016-03-14, at 20:26", "from": u"John Doe <john@doe.example>"},
        )

        data = parse_reply(
            u"Le 6 janv. 2014 à 19:50, John Doe <john@doe.example> a écrit :"
        )
        self.assertEqual(
            data,
            {
        ...
        data = parse_reply(
            u"Le 02.10.2013 à 11:13, John Doe <john@doe.example> a écrit :"
        )
        self.assertEqual(
            data,
            {"date": u"02.10.2013 \xe0 11:13", "from": u"John Doe <john@doe.example>"},
        )

        data = parse_reply(u"El 11/07/2012 06:13 p.m., John Doe escribió:")
        self.assertEqual(data, {"date": u"11/07/2012 06:13 p.m.", "from": u"John Doe"})

        data = parse_reply(u"El 06/04/2010, a las 13:13, John Doe escribió:")
        self.assertEqual(
            data, {"date": u"06/04/2010, a las 13:13", "from": u"John Doe"}
        )

        data = parse_reply(u"2009/5/12 John Doe <john@doe.example>")
        self.assertEqual(
            data, {"date": u"2009/5/12", "from": u"John Doe <john@doe.example>"}
        )

        data = parse_reply(u"On 8 o'clock, John Doe wrote:")
        self.assertEqual(data, {"date": u"8 o'clock", "from": u"John Doe"})

        # Swedish
        data = parse_reply(
            u"Den 24 februari 2015 22:48 skrev John Doe <john@doe.example>:"
        )
        self.assertEqual(
            data,
            {"date": u"24 februari 2015 22:48", "from": u"John Doe <john@doe.example>"},
        )

        # Brazillian portuguese
        data = parse_reply(
            u"Em qui, 24 de jan de 2019 às 14:31, John Doe <john@doe.example> escreveu:"
        )
        self.assertEqual(
            data,
            {
